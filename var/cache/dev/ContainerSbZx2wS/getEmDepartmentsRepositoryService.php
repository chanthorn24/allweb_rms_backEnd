 ...
 */
class getEmDepartmentsRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\EmDepartmentsRepository' shared autowired service.
     *
     * @return \App\Repository\EmDepartmentsRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'EmDepartmentsRepository.php';

        return $container->privates['App\\Repository\\EmDepartmentsRepository'] = new \App\Repository\EmDepartmentsRepository(($container->services['doctrine'] ?? $container->getDoctrineService()));
    }
}
