...
<<<<<<<< HEAD:var/cache/dev/ContainerT2Sxn4R/getEmpLeaveReasonsRepositoryService.php
namespace ContainerT2Sxn4R;
========
namespace ContainerMSf4iSG;
>>>>>>>> 5e7cf5478ac31747339049b440a3a4f5a989f526:var/cache/dev/ContainerMSf4iSG/getEmpLeaveReasonsRepositoryService.php
 ...
 */
class getEmpLeaveReasonsRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\EmpLeaveReasonsRepository' shared autowired service.
     *
     * @return \App\Repository\EmpLeaveReasonsRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'EmpLeaveReasonsRepository.php';

        return $container->privates['App\\Repository\\EmpLeaveReasonsRepository'] = new \App\Repository\EmpLeaveReasonsRepository(($container->services['doctrine'] ?? $container->getDoctrineService()));
    }
}
