...
<<<<<<<< HEAD:var/cache/dev/ContainerT2Sxn4R/getUserEducationDegreesRepositoryService.php
namespace ContainerT2Sxn4R;
========
namespace ContainerMSf4iSG;
>>>>>>>> 5e7cf5478ac31747339049b440a3a4f5a989f526:var/cache/dev/ContainerMSf4iSG/getUserEducationDegreesRepositoryService.php
 ...
 */
class getUserEducationDegreesRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\UserEducationDegreesRepository' shared autowired service.
     *
     * @return \App\Repository\UserEducationDegreesRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'UserEducationDegreesRepository.php';

        return $container->privates['App\\Repository\\UserEducationDegreesRepository'] = new \App\Repository\UserEducationDegreesRepository(($container->services['doctrine'] ?? $container->getDoctrineService()));
    }
}
