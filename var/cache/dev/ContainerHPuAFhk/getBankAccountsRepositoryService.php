 ...
 */
class getBankAccountsRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\BankAccountsRepository' shared autowired service.
     *
     * @return \App\Repository\BankAccountsRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'BankAccountsRepository.php';

        return $container->privates['App\\Repository\\BankAccountsRepository'] = new \App\Repository\BankAccountsRepository(($container->services['doctrine'] ?? $container->getDoctrineService()));
    }
}
