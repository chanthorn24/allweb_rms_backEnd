 ...
 */
class getBanksRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\BanksRepository' shared autowired service.
     *
     * @return \App\Repository\BanksRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'BanksRepository.php';

        return $container->privates['App\\Repository\\BanksRepository'] = new \App\Repository\BanksRepository(($container->services['doctrine'] ?? $container->getDoctrineService()));
    }
}
