 ...
 */
class getFamilyRelationshipRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\FamilyRelationshipRepository' shared autowired service.
     *
     * @return \App\Repository\FamilyRelationshipRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'FamilyRelationshipRepository.php';

        return $container->privates['App\\Repository\\FamilyRelationshipRepository'] = new \App\Repository\FamilyRelationshipRepository(($container->services['doctrine'] ?? $container->getDoctrineService()));
    }
}
