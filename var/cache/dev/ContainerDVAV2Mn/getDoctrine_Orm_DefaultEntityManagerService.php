...
class getDoctrine_Orm_DefaultEntityManagerService extends App_KernelDevDebugContainer
{
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        $a->setRepositoryFactory(new \Doctrine\Bundle\DoctrineBundle\Repository\ContainerRepositoryFactory(new \Symfony\Component\DependencyInjection\Argument\ServiceLocator($container->getService, [
            'App\\Repository\\BankAccountsRepository' => ['privates', 'App\\Repository\\BankAccountsRepository', 'getBankAccountsRepositoryService', true],
            'App\\Repository\\BanksRepository' => ['privates', 'App\\Repository\\BanksRepository', 'getBanksRepositoryService', true],
            'App\\Repository\\EmpAttendanceTypesRepository' => ['privates', 'App\\Repository\\EmpAttendanceTypesRepository', 'getEmpAttendanceTypesRepositoryService', true],
            'App\\Repository\\EmpAttendancesRepository' => ['privates', 'App\\Repository\\EmpAttendancesRepository', 'getEmpAttendancesRepositoryService', true],
            'App\\Repository\\EmpDepartmentsRepository' => ['privates', 'App\\Repository\\EmpDepartmentsRepository', 'getEmpDepartmentsRepositoryService', true],
            'App\\Repository\\EmpFamiliesRepository' => ['privates', 'App\\Repository\\EmpFamiliesRepository', 'getEmpFamiliesRepositoryService', true],
            'App\\Repository\\EmpLeaveReasonsRepository' => ['privates', 'App\\Repository\\EmpLeaveReasonsRepository', 'getEmpLeaveReasonsRepositoryService', true],
            'App\\Repository\\EmpLeavesRepository' => ['privates', 'App\\Repository\\EmpLeavesRepository', 'getEmpLeavesRepositoryService', true],
            'App\\Repository\\EmpPositionsRepository' => ['privates', 'App\\Repository\\EmpPositionsRepository', 'getEmpPositionsRepositoryService', true],
            'App\\Repository\\FamilyRelationshipRepository' => ['privates', 'App\\Repository\\FamilyRelationshipRepository', 'getFamilyRelationshipRepositoryService', true],
            'App\\Repository\\FamilyRelationshipsRepository' => ['privates', 'App\\Repository\\FamilyRelationshipsRepository', 'getFamilyRelationshipsRepositoryService', true],
            'App\\Repository\\SchoolDegreesRepository' => ['privates', 'App\\Repository\\SchoolDegreesRepository', 'getSchoolDegreesRepositoryService', true],
            'App\\Repository\\UserEducationDegreesRepository' => ['privates', 'App\\Repository\\UserEducationDegreesRepository', 'getUserEducationDegreesRepositoryService', true],
            'App\\Repository\\UserRolesRepository' => ['privates', 'App\\Repository\\UserRolesRepository', 'getUserRolesRepositoryService', true],
            ...
            'App\\Repository\\FamilyRelationshipRepository' => '?',
