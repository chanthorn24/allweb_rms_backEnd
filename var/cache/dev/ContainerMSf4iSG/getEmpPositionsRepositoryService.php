...
<<<<<<<< HEAD:var/cache/dev/ContainerT2Sxn4R/getEmpPositionsRepositoryService.php
namespace ContainerT2Sxn4R;
========
namespace ContainerMSf4iSG;
>>>>>>>> 5e7cf5478ac31747339049b440a3a4f5a989f526:var/cache/dev/ContainerMSf4iSG/getEmpPositionsRepositoryService.php
 ...
 */
class getEmpPositionsRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\EmpPositionsRepository' shared autowired service.
     *
     * @return \App\Repository\EmpPositionsRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'EmpPositionsRepository.php';

        return $container->privates['App\\Repository\\EmpPositionsRepository'] = new \App\Repository\EmpPositionsRepository(($container->services['doctrine'] ?? $container->getDoctrineService()));
    }
}
