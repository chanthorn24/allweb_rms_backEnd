...
<<<<<<<< HEAD:var/cache/dev/ContainerT2Sxn4R/getEmpAttendancesRepositoryService.php
namespace ContainerT2Sxn4R;
========
namespace ContainerMSf4iSG;
>>>>>>>> 5e7cf5478ac31747339049b440a3a4f5a989f526:var/cache/dev/ContainerMSf4iSG/getEmpAttendancesRepositoryService.php
 ...
 */
class getEmpAttendancesRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\EmpAttendancesRepository' shared autowired service.
     *
     * @return \App\Repository\EmpAttendancesRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'EmpAttendancesRepository.php';

        return $container->privates['App\\Repository\\EmpAttendancesRepository'] = new \App\Repository\EmpAttendancesRepository(($container->services['doctrine'] ?? $container->getDoctrineService()));
    }
}
