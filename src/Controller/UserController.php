    ...
    public function getAllUser(): JsonResponse
    {
        try {
            ...
            foreach ($users as $user) {
                $delete = (boolean) $user->getIsDelete();
//                if($delete) {
                    $res[] = [
                        "id" => $user->getId(),
...
//                }
    ...
    /**
     * @Route("/api/user/update/{id}", name="create_user", methods="POST")
     * @param $id
     * @param Request $request
     * @return JsonResponse
     */
    public function update($id, Request $request): JsonResponse
    {
        ...
        try {
            ...
            //save to database
            $this->em->flush();
            return $this->json(array("success" => false, "message" => "update successfully", "data" => $res), 200);
        } catch (\Exception $error) {
            return $this->json(array("success" => false, "message" => $error->getMessage()), 400);
        }
    }
